        ...
        <div className='w-full max-w-6xl m-5'>
            ...
            <div className='bg-white border-rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
                ...
                {appointments.map((item, index) => {
                    return <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_0.5fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-100' key={index}>
