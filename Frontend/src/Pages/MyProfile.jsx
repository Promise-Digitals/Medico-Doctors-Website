...
const MyProfile = () => {
    ...
    const [userData, setUserData] = useState({
        ...
        email: 'promiseedeh025@gmail.com',
        phone: '+234-808957774848',
        address: {
            line1: "No 10 Etudo Street",
            line2: "Acharalayout, Enugu, Enugu State"
        },
        gender: 'Male',
        dob: '1999-01-02'
    })
    ...
    return (
        <div className='max-w-lg flex flex-col gap-2 text-sm '>
            ...
            <div className='mt-10'>
                {
                    isEdit
                    ? <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all duration-300' onClick={() => setIsEdit(false)}>Save Infomation</button>
